 ...
 */
public class ConsumerWithDifferentGroup {
    KafkaConsumer<String, String> kafkaConsumer;

    ConsumerWithDifferentGroup(){
    ...
    private static final Properties CONSUMER_PROPERTIES(){
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "group2");   // different group than others
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "latest");
        return properties;
    }

    public static void main(String[] args) {
        new ConsumerWithDifferentGroup().consume();
    }
}
